...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch : {
      ...
      //buildUI: {
      //  files: [
      //    '<%= yeoman.client %>/components/ui/**/*.js',
      //    '!<%= yeoman.client %>/components/ui/**/*.spec.js',
      //    '!<%= yeoman.client %>/components/ui/**/*.mock.js',
      //  ],
      //  tasks: ['']
      //},
      mochaTest : {
    ...
    ngdocs : {
      options : {
        dest : 'client/components/doc'
      },
      api : {
        // src: [
        //  'client/components/src/service/scGeo.js'
        //  ,'client/components/src/service/scModel.js'
        //  ,'client/components/src/service/scUtil.js',
        //  'client/components/src/provider/*.js'],
        src : ['client/components/src/**/*.js'],
  ...
  grunt.registerTask('serve',
    ...
    grunt.task.run(['clean:server', 'env:all', 'concurrent:server', 'injector',
        //'wiredep',
        'autoprefixer', 'express:dev', 'wait', 'open', 'watch']);
  });
